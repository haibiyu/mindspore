...
parser.add_argument('--checkpoint_path', type=str, default='output', help='CheckPoint file path.')
parser.add_argument('--dataset_path', type=str, default='cifar10_data/eval', help='Dataset path.')
...
#             param_dict = load_checkpoint(args_opt.checkpoint_path)
            param_dict = load_checkpoint('train_resnet_cifar10_1_9_1562.ckpt')
